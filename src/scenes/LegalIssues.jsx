        ...
        <>
            ...
            <div className="Home-banner-wrapper">
                <div className="banner">
                    <div className="banner-content">
                        <p className='banner-topic'>LEGAL AID AND
                            SUPPORT</p>
                        <p className='banner-subTopic legal-banner-sub'>Providing Comprehensive Legal Assistance
                ...
                <div className="service-container">
                    <div className="service-main">
                        <div className="service-content">
                            ...
                            <p className='service-content-des'>Get expert legal advice from an experienced lawyer.
                            </p>
                            <p className='service-content-des'>
                                Our service offers consultations to help you understand your rights, obligations,
                                and potential courses of action.</p>
                        </div>
                    </div>
                ...
                <div className="eligible-content-wrapper">
                    ...
                    <div className="eligible-criteria">
                        <div className="criteria-1">
                            ...
                            <p>Cannot provide the necessities of life (food, clothing, decent shelter) for themselves.
                                Does not have sufficient means to afford a lawyer.</p>
                        </div>

                        <div className="criteria-1 criteria-2">
                            <p>Special Cases</p>
                            <p>Children in Conflict with the Law (CICL)</p>
                            <p>Provided with legal advice and assistance regardless of financial capacity if the interest
                                of justice requires it.</p>
                        </div>

                        <div className="criteria-1 criteria-3">
                            <p>Persons with Permanent Physical or Mental and Social Disabilities</p>
                            <p>Eligible for legal advice and assistance regardless of financial capacity if the interest of
                                justice requires it.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="legal-grid-container">
                ...
                <div class="legal-grid-item legal-grid-item-rest">
                    ...
                    <p className="issues-des">We help clients resolve conflicts over contract obligations, negotiate settlements,
                        and, if necessary, represent them in court to enforce or defend their contractual rights.</p>
                </div>

                <div class="legal-grid-item legal-grid-item-rest">
                    <MdOutlineFamilyRestroom className='issues-icon' />
                    <p className="issues-topic">Family Law Matters</p>
                    <p className="issues-des">Our services include mediation and representation in divorce proceedings, child custody
                        and visitation disputes, spousal and child support arrangements, and adoption processes.</p>
                </div>

                <div class="legal-grid-item legal-grid-item-rest">
                    <MdOutlineAssuredWorkload className='issues-icon' />
                    <p className="issues-topic">Criminal Defense</p>
                    <p className="issues-des">Our legal team provides defense strategies, represents clients in court, negotiates
                        plea bargains, and works to protect the rights of the accused at all stages of the criminal justice process.</p>
                </div>

                <div class="legal-grid-item legal-grid-item-rest">
                    <MdDiversity3 className='issues-icon' />
                    <p className="issues-topic">Employment and Labor
                        Issues</p>
                ...
                <div class="legal-grid-item legal-grid-item-rest">
                    ...
                    <p className="issues-des">We represent clients in obtaining compensation for medical expenses, lost wages, pain and
                        suffering, and other damages resulting from car accidents, slip and falls, medical malpractice, and other personal injury cases.</p>
                </div>

                <div class="legal-grid-item legal-grid-item-rest">
                    <MdOutlineVerifiedUser className='issues-icon' />
                    <p className="issues-topic">Consumer Protection
                        Issues</p>
                ...
                <div class="legal-grid-item legal-grid-item-rest">
                    ...
                    <p className="issues-topic">Estate Planning and
                        Probate</p>
